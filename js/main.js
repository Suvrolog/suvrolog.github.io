...
(function () {
  var container = document.querySelectorAll('.header__select');
  container.forEach(function (item) {
    var dropDownItems = item.querySelectorAll('.dropDown__item');
    var defaultSpan = item.querySelector('.default');
    defaultSpan.textContent = dropDownItems[0].textContent;
    defaultSpan.addEventListener('click', function () {
      var dropDown = this.closest('div').querySelector('.dropDown');
      var dropDowns = this.closest('.header__form').querySelectorAll('.dropDown');
