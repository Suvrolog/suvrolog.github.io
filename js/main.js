...
(function () {
  var container = document.querySelectorAll('.dropdown__select');
  container.forEach(function (item) {
    var dropDownItems = item.querySelectorAll('.dropdown__item');
    var defaultSpan = item.querySelector('.dropdown__default');
    defaultSpan.textContent = dropDownItems[0].textContent;
    defaultSpan.addEventListener('click', function () {
      var dropDown = this.closest('div').querySelector('.dropdown__row');
      var dropDowns = this.closest('.dropdown').querySelectorAll('.dropdown__row');
